...
products_table = dynamodb.Table(os.environ.get("DYNAMODB_TABLE_NAME", "catalog-service-table"))
variants_table = dynamodb.Table(os.environ.get("DYNAMODB_VARIANTS_TABLE_NAME", "Variants"))
